...
public class OptimisedParameterPage implements IPropertyContent {
    ...
    public void update(ModelElement element, IModulePropertyTable table) {
        ...
        value = ModelUtils.getTaggedValue(CPSwarmTagTypes.OPTIMISED_FILE, elt);
    ...
    public int changeProperty(ModelElement element, int row, String value) {
        if(row == 1){
            ...
            ModelUtils.addValue(ICPSwarmPeerModule.MODULE_NAME, CPSwarmTagTypes.OPTIMISED_FILE, value, element);
        }
        return 4;
    }
