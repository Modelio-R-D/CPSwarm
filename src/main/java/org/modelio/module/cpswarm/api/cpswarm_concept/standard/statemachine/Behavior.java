 ...
 */
package org.modelio.module.cpswarm.api.cpswarm_concept.standard.statemachine;
...
/**
 * Proxy class to handle a {@link StateMachine} with << Behavior >> stereotype.
 * <p>Stereotype description:
 * <br/><i>null</i></p>
 */
public abstract class Behavior {
    public static final String STEREOTYPE_NAME = "Behavior";
    ...
    protected Behavior(final StateMachine elt) {
        this.elt = elt;
    }
    ...
    public static final class MdaTypes {
        ...
        public static void init(final IModuleContext ctx) {
            STEREOTYPE_ELT = ctx.getModelingSession().findElementById(Stereotype.class, "a993fdfc-bb89-477d-99fe-2a4b3bc43f27");
