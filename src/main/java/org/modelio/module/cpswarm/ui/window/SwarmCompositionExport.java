 ...
 * @author ebrosse
 */
public class SwarmCompositionExport extends AbstractSwtWizardWindow {
    public Object open() {
        createContents();
        return super.open();
    }
    ...
    public SwarmCompositionExport(Shell parent) {
        super(parent);
    }
    ...
    public void setLabels() {
        ...
        setFrametitle("Swarm Composition Generation");
    ...
    public void validationAction() {
        ...
        SwarmCompositionGeneration commGen = new SwarmCompositionGeneration((org.modelio.metamodel.uml.statik.Class) this.selectedElt, file);
        commGen.generate();    
