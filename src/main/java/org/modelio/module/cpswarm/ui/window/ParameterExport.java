...
import org.modelio.module.cpswarm.generator.OptimisedParameterGeneration;
 ...
 * @author ebrosse
 */
public class ParameterExport extends AbstractSwtWizardWindow {
    @Override
    public Object open() {
        createContents();
        return super.open();
    ...
    private void createContents() {
        ...
        this.fileChooserComposite.getSearch().addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent e) {
                ParameterExport.this.fileChooserComposite.searchFile();
            }
        });
    ...
    public ParameterExport(Shell parent) {
        super(parent);
    }
    ...
    public void setLabels() {
        ...
        setFrametitle("Optimisation Parameters Export");
    ...
    public void validationAction() {
        ...
        OptimisedParameterGeneration generation = new OptimisedParameterGeneration(theFile);
        generation.generate();
        completeBox();
    }
    ...
    public void setPath() {
        ...
        this.fileChooserComposite.setText(ResourcesManager.getInstance().getGeneratedPath() + File.separator + "param.json");
    }

    @Override
    public void setDefaultDialog() {
        this.fileChooserComposite.getDialog().setFilterNames(new String[] { "*.json" });
