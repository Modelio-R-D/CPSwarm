...
/**
 * This class handles the palette configuration of Fitness Function diagram
 * @author ebrosse
 */
public class FitnessFunctionDiagramCustomizer extends CPSwarmDiagramCustomizer implements IDiagramCustomizer {
    @Override
