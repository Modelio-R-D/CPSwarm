...
public class PortInOutTool extends DefaultBoxTool {
    @Override
    ...
    public void actionPerformed(final IDiagramHandle representation, final IDiagramGraphic parent, final Rectangle rect) {
        ...
        try (ITransaction transaction = session.createTransaction("org.modelio.module.CPSwarm.command.diagram.PortInOutTool")) {
