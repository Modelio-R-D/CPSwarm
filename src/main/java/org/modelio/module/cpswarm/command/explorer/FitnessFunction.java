...
public class FitnessFunction extends DefaultModuleCommandHandler {
    @Override
    public void actionPerformed(final List<MObject> selectedElements, final IModule module) {
        ...
        MessageDialog.openInformation(Display.getDefault().getActiveShell(), "FitnessFunction", "Command not implemented!");
    }
