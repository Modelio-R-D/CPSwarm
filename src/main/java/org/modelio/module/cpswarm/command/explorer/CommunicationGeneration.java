...
import org.modelio.module.cpswarm.ui.window.CommunicationExport;
import org.modelio.vcore.smkernel.mapi.MObject;

public class CommunicationGeneration extends DefaultModuleCommandHandler {
    @Override
    public void actionPerformed(List<MObject> selectedElements, IModule module) {
        CommunicationExport export = new CommunicationExport(Display.getCurrent().getActiveShell());
    ...
    public boolean accept(List<MObject> selectedElements, IModule module) {
        return ((selectedElements.get(0) instanceof org.modelio.metamodel.uml.statik.Class)
                && (((ModelElement)selectedElements.get(0)).isStereotyped(ICPSwarmPeerModule.MODULE_NAME, CPSwarmStereotypes.SWARMMEMBER))) ;
    }
