...
import org.modelio.module.cpswarm.ui.window.FitnessFunctionExport;
import org.modelio.vcore.smkernel.mapi.MObject;

public class FitnessFunctionGeneration extends DefaultModuleCommandHandler {
    @Override
    public void actionPerformed(List<MObject> selectedElements, IModule module) {
        FitnessFunctionExport export = new FitnessFunctionExport(Display.getCurrent().getActiveShell());
