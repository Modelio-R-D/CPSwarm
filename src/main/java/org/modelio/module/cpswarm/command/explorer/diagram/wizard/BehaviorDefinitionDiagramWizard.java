...
/**
 * This class handles the creation of CPSwarm Behavior Definition diagram
 * @author ebrosse
 */
public class BehaviorDefinitionDiagramWizard extends AbstractWizardContributor {
    @Override
    ...
    public BehaviorDefinitionDiagramWizard() {
        super();
