...
public abstract class CompositeConstraint extends CamelConstraint {
    @objid ("575bc358-ffd2-4581-9df2-c167a8246695")
    public static final String STEREOTYPE_NAME = "CompositeConstraint";

    @objid ("e452cb37-1df8-4710-800c-f07565a7eb33")
    @Override
     ...
     */
    @objid ("afd0ce79-ab1a-43ad-9a18-10285d5a10f1")
    @Override
    public Constraint getElement() {
        return (Constraint)super.getElement();
    }

    @objid ("5a569fdd-e314-4407-a218-321ef4c1bbc7")
    @Override
    public int hashCode() {
        return 23 + ((this.elt == null) ? 0 : this.elt.hashCode());
    }

    @objid ("e1488a0d-c7f7-42b4-a2a9-e7f4bd8fe709")
    ...
    public static final class MdaTypes {
        @objid ("c94d9dc2-7653-4e6e-85c6-4f173ebeb058")
        public static Stereotype STEREOTYPE_ELT;

        @objid ("24dd0f78-b3de-44eb-84aa-9235e9231600")
        private static Stereotype MDAASSOCDEP;

        @objid ("b1b60970-ac41-4b4a-b140-f1ef3bbb4097")
        private static TagType MDAASSOCDEP_ROLE;

        @objid ("e2d7dcfb-5045-45b5-acf3-9e7a23302caf")
