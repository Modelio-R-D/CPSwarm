...
public class CamelDesignerProxyFactory {
    @objid ("c4f1872b-667a-40a7-89d0-c366b6cb23ba")
     ...
     */
    @objid ("2b029092-7cee-41d1-846a-6c8f87b50cff")
     ...
     * @return the right proxy or <i>null</i>.
     */
    @objid ("cdd85114-7c94-408f-94b9-de85be7655cb")
    public static final Object instantiate(final Element e, final String stName) {
        instantiateVisitor.setStereotype(stName);
        return e.accept(instantiateVisitor);
    }

    @objid ("9d6ad005-4e08-4c74-96c8-5f8945fab864")
    private static class InstantiateVisitor implements IDefaultModelVisitor, IDefaultInfrastructureVisitor {
        @objid ("1a165c16-8712-48d3-a9a2-9657b13c51be")
        private String stName;

        @objid ("30323930-9cc0-445f-9fe8-56261d3b6d5f")
        public final void setStereotype(final String stName) {
            this.stName = stName;
        }

        @objid ("a4fc81f1-75b3-47a4-9d5b-43371a1caf4b")
        @Override
        ...
        @objid ("299a326a-f07d-414b-8480-274ca80820a5")
        @Override
        ...
        @objid ("d203ad8a-f2de-41a3-9513-e0e3b60c0e8a")
        @Override
        ...
        @objid ("6d50c6a5-b451-4553-bbf3-0a0a6d38244b")
        @Override
        ...
        @objid ("01626094-d2b5-49da-9271-4086d312740c")
        @Override
        ...
        @objid ("7cf29fce-f079-4a57-bb7f-f84b66d1e9e3")
        @Override
        ...
        @objid ("3c6d65a9-9723-4a14-93a7-b28d9d197b0d")
        @Override
        ...
        @objid ("837d575e-f0fb-468a-8714-f5b9e4461f3c")
        @Override
        ...
        @objid ("e01652df-9e27-4ddf-9857-274262e72461")
        @Override
        ...
        @objid ("123432f0-b821-412b-ac8a-ba1c4807d8a2")
        @Override
        ...
        @objid ("5a805c26-1dca-41ad-9e93-d1107e256d86")
        @Override
        ...
        @objid ("40f71c98-b4a6-4eb3-a8f2-aa3b885e28d2")
        @Override
        ...
        @objid ("36e3d57c-1b1d-4469-bb9b-6238781b5e6a")
        @Override
        ...
        @objid ("0f479c9d-b14c-40f0-abfa-651c0b1f78bd")
        @Override
        ...
        @objid ("52a73ff7-f223-4c5d-a9e5-e1433c3d127d")
        @Override
        ...
        @objid ("8de5dd54-2375-4a87-8d5c-e4a43303d4de")
        @Override
         ...
         */
        @objid ("3500196a-c247-44b8-9ef3-1494e7c3b807")
        @Override
