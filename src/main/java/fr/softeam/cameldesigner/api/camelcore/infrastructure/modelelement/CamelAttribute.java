...
public abstract class CamelAttribute extends NamedElement {
    @objid ("bd14d9b7-5d2d-40b8-97f1-debdbba1790e")
    public static final String STEREOTYPE_NAME = "CamelAttribute";

    @objid ("32fe2b1d-d381-41aa-a659-15fa4d0a7b4f")
    @Override
     ...
     */
    @objid ("70298b2d-33b4-4481-a5a0-c6810f327b71")
    @Override
    public ModelElement getElement() {
        return (ModelElement)super.getElement();
    }

    @objid ("3cce39c5-8f10-461a-b16d-21add4b56b90")
    @Override
    public int hashCode() {
        return 23 + ((this.elt == null) ? 0 : this.elt.hashCode());
    }

    @objid ("c0e2e6df-3fc0-4bad-bda1-7ea25c31a409")
    ...
    public static final class MdaTypes {
        @objid ("e07b15ea-6d1b-4cef-b462-eabf5945186a")
        public static Stereotype STEREOTYPE_ELT;

        @objid ("0a1d2455-3574-4ef7-a716-698d6c4bea17")
        private static Stereotype MDAASSOCDEP;

        @objid ("367e3064-ee77-48c5-93d2-8e12f3fab4d1")
        private static TagType MDAASSOCDEP_ROLE;

        @objid ("2572798b-5686-4491-8064-f11bb707de8c")
