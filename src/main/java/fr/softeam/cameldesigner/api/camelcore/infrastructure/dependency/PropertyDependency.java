...
public class PropertyDependency extends CamelElement {
    @objid ("9abae601-08de-4247-a2bc-9b2dddc2319d")
     ...
     */
    @objid ("4fc1ce10-e8f7-4f5b-9b50-fae6afb29ed9")
     ...
     */
    @objid ("2f8201ec-be87-4e08-b882-c9fa12f58a37")
     ...
     */
    @objid ("eebd4960-deca-4060-a79f-6b19a9bbf722")
     ...
     */
    @objid ("9d842c85-d379-4d0a-83e5-481596c6cf6d")
    ...
    @objid ("2adcbb39-cb5e-4daa-a86f-7ddb94f4e609")
    @Override
     ...
     */
    @objid ("e4cc113f-9088-4604-9df0-8be406cc0979")
    @Override
    public Dependency getElement() {
        return (Dependency)super.getElement();
    }

    @objid ("d3bb9780-787a-4952-b5e3-8606bf8609a3")
    @Override
    public int hashCode() {
        return 23 + ((this.elt == null) ? 0 : this.elt.hashCode());
    }

    @objid ("bbd9b4f5-5bb5-4055-99b0-6e31ab88ca21")
    ...
    public static final class MdaTypes {
        @objid ("7ea781c7-a4a0-447f-a74e-1bf0e1b50a63")
        public static Stereotype STEREOTYPE_ELT;

        @objid ("f1f0dc65-a05e-40d1-99bd-715657ae727a")
        private static Stereotype MDAASSOCDEP;

        @objid ("57441a31-b9ac-43cc-8874-b74ded82c837")
        private static TagType MDAASSOCDEP_ROLE;

        @objid ("73dd5316-87a2-4ca5-bc13-486737c30e8c")
