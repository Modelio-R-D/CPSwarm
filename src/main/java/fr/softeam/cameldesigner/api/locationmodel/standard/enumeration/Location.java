...
public abstract class Location extends Feature {
    @objid ("dd5cfc2b-72b2-41b7-aa04-4de7c5ba94a7")
    public static final String STEREOTYPE_NAME = "Location";

    @objid ("4af9ac97-2c2e-4574-b0a9-426bfea24d35")
    ...
    @objid ("586ed002-7fe8-4608-8256-b24577bf625d")
    @Override
     ...
     */
    @objid ("bd5e2286-e128-4c1d-b986-d7f335fe231f")
    @Override
     ...
     * <br/><i>null</i></p>
     */
    @objid ("0c681a07-ae7c-4a35-8294-f6f8a1fbdb97")
    public String getId() {
        return this.elt.getTagValue(Location.MdaTypes.ID_TAGTYPE_ELT);
    }

    @objid ("3eb988c3-a85c-4ca0-97b1-7d681cfb2ce5")
    @Override
    public int hashCode() {
     ...
     * <br/><i>null</i></p>
     */
    @objid ("d378c5f7-61c7-4340-a821-5fbdc8faf4b5")
    public void setId(final String value) {
        this.elt.putTagValue(Location.MdaTypes.ID_TAGTYPE_ELT, value);
    }

    @objid ("8c7cdad5-166d-456c-9a14-02466afd417e")
    ...
    public static final class MdaTypes {
        @objid ("a29d6efe-0e5c-40a6-9e71-9fc0bfdfdcf2")
        public static Stereotype STEREOTYPE_ELT;

        @objid ("0fc2b96e-5ddb-491e-a93e-82006687d53f")
        public static TagType ID_TAGTYPE_ELT;

        @objid ("1772e8ce-e1e7-45bd-9b18-0d738db2ad8f")
        private static Stereotype MDAASSOCDEP;

        @objid ("dc3ea7e7-594f-4b45-988c-1297c012acd8")
        private static TagType MDAASSOCDEP_ROLE;

        @objid ("f3707a20-f9fb-463e-b84f-713d6c7deabc")
