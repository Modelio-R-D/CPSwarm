...
public abstract class Requirement extends Feature {
    @objid ("0445598c-406d-40a0-a6fe-03c3abd81042")
    public static final String STEREOTYPE_NAME = "Requirement";

    @objid ("48e37831-0347-493b-882b-4579dc111352")
    @Override
     ...
     */
    @objid ("def36f99-ddba-4dd2-9d2a-62aa188cd9a3")
    @Override
    public GeneralClass getElement() {
        return (GeneralClass)super.getElement();
    }

    @objid ("301233c5-e89a-454a-8b50-b274fafd73fc")
    @Override
    public int hashCode() {
        return 23 + ((this.elt == null) ? 0 : this.elt.hashCode());
    }

    @objid ("41682fb1-0848-403b-b979-9f6d5f205c9a")
    ...
    public static final class MdaTypes {
        @objid ("c5d57503-a0dd-475d-b539-12748a5894fc")
        public static Stereotype STEREOTYPE_ELT;

        @objid ("68ac1e91-4dbe-416c-8886-c81608666592")
        private static Stereotype MDAASSOCDEP;

        @objid ("06aec242-1012-49e9-b56c-d45f6fc301c5")
        private static TagType MDAASSOCDEP_ROLE;

        @objid ("44ab551c-442c-4650-b99c-7a37d6bd5e69")
