...
public class UnaryEventPattern extends EventPattern {
    @objid ("e7a9f9d2-fd1d-42de-b2fc-183df4dd50fb")
    public static final String STEREOTYPE_NAME = "UnaryEventPattern";

    @objid ("f68f3148-e2e0-401c-9071-9a82b1f6215b")
    public static final String OCCURRENCENUM_TAGTYPE = "occurrenceNum";

    @objid ("30df54db-668c-45bc-8a66-35259140a9f5")
     ...
     */
    @objid ("3cdee6e3-4865-4845-acbc-6bb34823b221")
     ...
     */
    @objid ("c89bc2dc-a92b-4b8d-b2d5-fe512de68cba")
     ...
     */
    @objid ("1bd8a0cd-f776-40d1-9951-be1ade52944b")
     ...
     */
    @objid ("e97a65c6-84ba-416a-86ab-e6fc92259570")
    ...
    @objid ("f0b506d0-5f27-4582-9585-43379006de77")
    @Override
     ...
     */
    @objid ("48414c28-8dbe-4b83-a83e-89efbc31344b")
    @Override
     ...
     * <br/><i>null</i></p>
     */
    @objid ("2a559510-509d-4d5e-abcd-aafe39d05181")
     ...
     * <br/><i>null</i></p>
     */
    @objid ("c1d9ac13-59e5-4f97-8012-9654b04ed060")
    public String getOperator() {
        return this.elt.getTagValue(UnaryEventPattern.MdaTypes.OPERATOR_TAGTYPE_ELT);
    }

    @objid ("31bff657-7d13-432b-8a3f-0769ad687e71")
    @Override
    public int hashCode() {
     ...
     * <br/><i>null</i></p>
     */
    @objid ("71b9df24-7b0c-49d3-8f3e-edab59c89f13")
    ...
    public static final class MdaTypes {
        @objid ("38904563-73af-4368-b262-8f96bf8822e7")
        public static Stereotype STEREOTYPE_ELT;

        @objid ("61acbc7a-a77c-4099-a766-a229a7521d40")
        public static TagType OCCURRENCENUM_TAGTYPE_ELT;

        @objid ("394a0117-4ed2-40d2-8da4-05654fc1c58e")
        public static TagType OPERATOR_TAGTYPE_ELT;

        @objid ("c8187098-02df-4943-8bc1-a35a7bf415cd")
        private static Stereotype MDAASSOCDEP;

        @objid ("50b17ce9-36b0-43c2-b082-5a02405c0968")
        private static TagType MDAASSOCDEP_ROLE;

        @objid ("f50cf0ab-fe17-481c-973f-5845e5e61057")
